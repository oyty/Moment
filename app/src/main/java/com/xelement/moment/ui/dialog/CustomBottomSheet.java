...
public class CustomBottomSheet extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setWindowAnimations(R.style.AnimEnterExit);
...
//        set.setDuration(mAnimationDuration);
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                mContentView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            CustomBottomSheet.super.dismiss();
                        } catch (Exception e) {
        ...
        mContentView.startAnimation(translate);
...
//        animateDown();
    ...
    /**
     * 生成列表类型的 {@link CustomBottomSheet} 对话框。
     */
    public static class BottomListSheetBuilder {

        private Context mContext;

        private CustomBottomSheet mDialog;
        ...
        private BottomListSheetBuilder.OnSheetItemClickListener mOnSheetItemClickListener;
        ...
        public BottomListSheetBuilder addItem(String textAndTag) {
            mItems.add(new BottomListSheetBuilder.BottomSheetListItemData(textAndTag, textAndTag));
            return this;
        }
        ...
        public BottomListSheetBuilder addItem(Drawable image, String textAndTag) {
            mItems.add(new BottomListSheetBuilder.BottomSheetListItemData(image, textAndTag, textAndTag));
            return this;
        }
        ...
        public BottomListSheetBuilder addItem(String text, String tag) {
            mItems.add(new BottomListSheetBuilder.BottomSheetListItemData(text, tag));
            return this;
        }
        ...
        public BottomListSheetBuilder addItem(int imageRes, String text, String tag) {
            ...
            mItems.add(new BottomListSheetBuilder.BottomSheetListItemData(drawable, text, tag));
            return this;
        }
        ...
        public BottomListSheetBuilder addItem(int imageRes, String text, String tag, boolean hasRedPoint) {
            Drawable drawable = imageRes != 0 ? ContextCompat.getDrawable(mContext, imageRes) : null;
            mItems.add(new BottomListSheetBuilder.BottomSheetListItemData(drawable, text, tag, hasRedPoint));
            return this;
        }
        ...
        public BottomListSheetBuilder addItem(int imageRes, String text, String tag, boolean hasRedPoint, boolean disabled) {
            Drawable drawable = imageRes != 0 ? ContextCompat.getDrawable(mContext, imageRes) : null;
            mItems.add(new BottomListSheetBuilder.BottomSheetListItemData(drawable, text, tag, hasRedPoint, disabled));
            return this;
        }

        public BottomListSheetBuilder setOnSheetItemClickListener(BottomListSheetBuilder.OnSheetItemClickListener onSheetItemClickListener) {
        ...
        public CustomBottomSheet build() {
            mDialog = new CustomBottomSheet(mContext);
        ...
        private View buildViews() {
            ...
            mAdapter = new BottomListSheetBuilder.ListAdapter();
        ...
        public interface OnSheetItemClickListener {
            void onClick(CustomBottomSheet dialog, View itemView, int position, String tag);
        }
        ...
        private class ListAdapter extends BaseAdapter {
            ...
            @Override
            public BottomListSheetBuilder.BottomSheetListItemData getItem(int position) {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                final BottomListSheetBuilder.BottomSheetListItemData data = getItem(position);
                final BottomListSheetBuilder.ViewHolder holder;
                if (convertView == null) {
                    LayoutInflater inflater = LayoutInflater.from(mContext);
                    convertView = inflater.inflate(R.layout.qmui_bottom_sheet_list_item, parent, false);
                    holder = new BottomListSheetBuilder.ViewHolder();
                    ...
                    holder = (BottomListSheetBuilder.ViewHolder) convertView.getTag();
                }
                if (data.image != null) {
    ...
    /**
     * 生成宫格类型的 {@link CustomBottomSheet} 对话框。
     */
    public static class BottomGridSheetBuilder implements View.OnClickListener {
        ...
        public BottomGridSheetBuilder addItem(int imageRes, CharSequence textAndTag, @BottomGridSheetBuilder.Style int style) {
            return addItem(imageRes, textAndTag, textAndTag, style, 0);
        }

        public BottomGridSheetBuilder addItem(int imageRes, CharSequence text, Object tag, @BottomGridSheetBuilder.Style int style) {
        ...
        public BottomGridSheetBuilder addItem(int imageRes, CharSequence text, Object tag, @BottomGridSheetBuilder.Style int style, int subscriptRes) {
        ...
        public BottomGridSheetBuilder addItem(View view, @BottomGridSheetBuilder.Style int style) {
            switch (style) {
                case FIRST_LINE:
        ...
        public interface OnSheetItemClickListener {
            void onClick(CustomBottomSheet dialog, View itemView);
        }
