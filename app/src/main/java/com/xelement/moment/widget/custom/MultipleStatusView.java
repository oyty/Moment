...
//        mInflater = LayoutInflater.from(context);
    ...
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mEmptyView) {
            mEmptyView = view;
            View emptyRetryView = mEmptyView.findViewById(R.id.ui_empty_retry_view);
    ...
    public final void showError(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mErrorView) {
            mErrorView = view;
            View errorRetryView = mErrorView.findViewById(R.id.ui_error_retry_view);
    ...
    public final void showNoNetwork(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mNoNetworkView) {
            mNoNetworkView = view;
            View noNetworkRetryView = mNoNetworkView.findViewById(R.id.ui_no_network_retry_view);
    ...
    public final void showContent() {
        ...
        if (null == mContentView && mContentViewResId != NULL_RESOURCE_ID && mInflater != null) {
